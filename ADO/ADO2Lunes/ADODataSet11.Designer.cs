...
namespace ADO2Lunes {
    ...
    public partial class ADODataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ADODataSet11.xsd";
...
namespace ADO2Lunes.ADODataSet1TableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [IdCliente] = @IdCliente, [Nombre] = @Nombre WHERE (([IdCliente] = @Original_IdCliente) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)));
SELECT IdCliente, Nombre FROM Cliente WHERE (IdCliente = @IdCliente)";
        ...
        public virtual int Delete(string Original_IdCliente, string Original_Nombre) {
        ...
        public virtual int Update(string IdCliente, string Nombre, string Original_IdCliente, string Original_Nombre) {
            if ((IdCliente == null)) {
                throw new global::System.ArgumentNullException("IdCliente");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Original_IdCliente, string Original_Nombre) {
            return this.Update(Original_IdCliente, Nombre, Original_IdCliente, Original_Nombre);
        }
    }

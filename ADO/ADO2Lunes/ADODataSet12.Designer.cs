...
namespace ADO2Lunes {
    ...
    public partial class ADODataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/ADODataSet12.xsd";
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClienteRow AddClienteRow(string IdCliente, string Apellidos, string Nombre) {
...
namespace ADO2Lunes.ADODataSet1TableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Cliente] WHERE (([IdCliente] = @Original_IdCliente) AND ((@IsN" +
                ...
                ")) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombr" +
                "e)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Cliente] ([IdCliente], [Apellidos], [Nombre]) VALUES (@IdClien" +
                "te, @Apellidos, @Nombre);\r\nSELECT IdCliente, Apellidos, Nombre FROM Cliente WHER" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cliente] SET [IdCliente] = @IdCliente, [Apellidos] = @Apellidos, [Nombre] = @Nombre WHERE (([IdCliente] = @Original_IdCliente) AND ((@IsNull_Apellidos = 1 AND [Apellidos] IS NULL) OR ([Apellidos] = @Original_Apellidos)) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)));
SELECT IdCliente, Apellidos, Nombre FROM Cliente WHERE (IdCliente = @IdCliente)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADO2Lunes.Properties.Settings.Default.ADOConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IdCliente, Apellidos, Nombre FROM dbo.Cliente";
        ...
        public virtual int Fill(ADODataSet1.ClienteDataTable dataTable) {
        ...
        public virtual ADODataSet1.ClienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ADODataSet1.ClienteDataTable dataTable = new ADODataSet1.ClienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ADODataSet1.ClienteDataTable dataTable) {
        ...
        public virtual int Delete(string Original_IdCliente, string Original_Apellidos, string Original_Nombre) {
        ...
        public virtual int Insert(string IdCliente, string Apellidos, string Nombre) {
            if ((IdCliente == null)) {
        ...
        public virtual int Update(string IdCliente, string Apellidos, string Nombre, string Original_IdCliente, string Original_Apellidos, string Original_Nombre) {
            if ((IdCliente == null)) {
                throw new global::System.ArgumentNullException("IdCliente");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Apellidos, string Nombre, string Original_IdCliente, string Original_Apellidos, string Original_Nombre) {
            return this.Update(Original_IdCliente, Apellidos, Nombre, Original_IdCliente, Original_Apellidos, Original_Nombre);
        }
    }
